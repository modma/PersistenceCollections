    ...
    public static class Tools
    {
        ...
        static Tools()
        {
            var dynamicMethod = new DynamicMethod("Memset", MethodAttributes.Public | MethodAttributes.Static, CallingConventions.Standard,
                null, new[] { typeof(IntPtr), typeof(byte), typeof(int) }, typeof(Tools), true);
        ...
        //https://stackoverflow.com/questions/1897555/what-is-the-equivalent-of-memset-in-c/29081346
        ...
        {
            Memset(array, 0, what, array?.Length ?? 0);
        }
        public static void Memzero(this byte[] array, int index, int length)
        {
            Memset(array, index, 0, length);
        }
        public static void Memzero(this byte[] array)
        {
            Memset(array, 0, 0, array?.Length ?? 0);
        }
